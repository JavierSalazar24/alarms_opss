            ...
            <div class="col-12">                
                <form id="form_editar_perfil" class="formulario_normal row mt-2 justify-content-evenly needs-validation" novalidate>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-floating mb-4">
                            <input class="form-control form-control-registrarse" placeholder="Email" type="email" name="correo" required id="email" value="<?php if(isset($correo)) echo $correo?>" readonly>
