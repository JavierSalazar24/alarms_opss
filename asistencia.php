					...
					<div class="preguntas">
						...
						<div class="contenedor-preguntas" data-categoria="entregas">
							...
							<div class="contenedor-pregunta">
								...
								<p class="respuesta">No, solo contamos con envíos a toda la Repúlica Mexicana. El costo de envío a tu ciudad es totalmente gratis, puedes comprar desde <a href="productos.php">aquí</a></p>
							</div>
						</div>
						<!-- Preguntas Seguridad -->
						...
						<div class="contenedor-preguntas" data-categoria="cuenta">
							<div class="contenedor-pregunta">
								...
								<p class="respuesta">Primeramente necesitas crear una cuenta para que puedas encontrar tus pedidos, ya con una cuenta creada puedes acceder desde <a href="mis_pedidos.php">aquí</a>.</p>
							</div>
							<div class="contenedor-pregunta">
								<p class="pregunta">¿Como puedo revisar el estatus de mi alarma comprada? <img src="./img/suma.svg" alt="Abrir Respuesta" /></p>
								<p class="respuesta">Primeramente necesitas crear una cuenta para que puedas encontrar el estatus de tus alarmas, ya con una cuenta creada puedes acceder desde <a href="alarmas.php">aquí</a>.</p>
							</div>
							<div class="contenedor-pregunta">
								<p class="pregunta">¿Como puedo manipular mi alarma comprada? <img src="./img/suma.svg" alt="Abrir Respuesta" /></p>
								<p class="respuesta">Para manipular tu alarma necesitas <a href="#">descargar</a> nuestra aplicación, ya con la aplicación necesitas crear una cuenta de usuario en este <a href="registrarse.php">sitio</a> y así podras usar tu alarma sin ningun problema.</p>
							</div>
							<div class="contenedor-pregunta">
