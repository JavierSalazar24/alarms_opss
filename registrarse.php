    ...
    <div id="registrarse" class="container">
        <div class="row justify-content-center pt-4 mt-3 m-1 mb-3 pb-4">
            <div class="col-12 formulario_registrarse">                
                <form id="form_registrarse" class="formulario_normal row mt-2 justify-content-evenly needs-validation" novalidate autocomplete="off">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating mb-4 pr-5">
                            <input class="form-control form-control-registrarse" placeholder="Nombre" minlength="3" pattern="[a-zA-Zá-úÁ-Ú ]+" type="text" name="nombre" required id="nombre" value="<?php if(isset($nombre)) echo $nombre?>">
                            <label class="label-registrarse" for="nombre">Nombre(s)</label>
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú nombre, mínimo 3 carácteres.</div>
                        </div>
                        ...
                        <div class="form-floating mb-4">
                            <input class="form-control form-control-registrarse" placeholder="Calle" minlength="3" type="text" name="calle" required id="calle" value="<?php if(isset($calle)) echo $calle?>">
                            <label class="label-registrarse" for="calle">Calle</label>
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú calle, mínimo 3 carácteres.</div>
                        </div> 
                        <div class="form-floating mb-4">
                            <input class="form-control form-control-registrarse" placeholder="Col. o Fracc." minlength="5" type="text" name="col_fracc" required id="col-fracc" value="<?php if(isset($col_fracc)) echo $col_fracc?>">
                            <label class="label-registrarse" for="col-fracc">Col. o Fracc.</label>
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú colonia o fraccionamiento, mínimo 5 carácteres.</div>
                        </div> 
                        <div class="form-floating mb-4">
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú contraseña, mínimo 8 carácteres.</div>
                        </div>  
                    </div>
                    <div class="col-md-3">
                        <div class="form-floating mb-4">
                            <input class="form-control form-control-registrarse" placeholder="Primer apellido" minlength="3" pattern="[a-zA-Zá-úÁ-Ú ]+" type="text" name="ape1" required id="ape1" value="<?php if(isset($ape1)) echo $ape1?>">
                            <label class="label-registrarse" for="ape1">Primer apellido</label>
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú primer apellido, mínimo 3 carácteres.</div>
                        </div>
                        <div class="form-floating mb-4">
                            ...
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú teléfono de 10 números.</div>
                        </div>    
                        <div class="form-floating mb-4">
                        ...
                        <div class="form-floating mb-4">
                            <input class="form-control form-control-registrarse" placeholder="Código Postal" type="tel" title="Solo números" minlength="5" maxlength="5" pattern="[0-9]+" name="cp" required id="cp" value="<?php if(isset($cp)) echo $cp?>">
                            <label class="label-registrarse" for="cp">Código Postal</label>
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor ingresa tú código postal, solo números.</div>
                        </div>    
                        <div class="form-floating mb-4">
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <div class="valid-feedback text-light"></div>
                            <div class="invalid-feedback text-light">Por favor confirma tu contraseña, mínimo 8 carácteres.</div>
                        </div>                        
                    </div>
