...
<body class="body-registrar">
    ...
    <div class="container container-registrarse">
        <section id="registrarse" class="row">
            <div class="col-12 text-center mb-5">
                <div>
                    <a href="index.php" class="x-ancla-registrarse">
                        <span class="x-registrarse">X</span>
                    </a>
                    <h1 class="h1-registrarse">Regístrate</h1>
                    <p>¿Ya tienes una cuenta? 
                        <a class="ancla-registrarse" href="iniciar_sesion.php">Iniciar sesión</a>
                    </p>
                </div>
            </div>
            <form id="form_registrarse" class="formulario_normal row mt-2 justify-content-evenly needs-validation" novalidate>
                <div class="col-md-3">
                    ...
                    <div class="form-floating mb-4">
                        ...
                        <div class="valid-feedback">Correcto.</div>
						<div class="invalid-feedback">Por favor ingresa tú contrase{a}.</div>
                    </div>  
                </div>
                <div class="col-md-3">
                    <div class="form-floating mb-4">
            ...
            <form id="form_registrarse" class="formulario_responsive row mt-2 justify-content-center needs-validation" novalidate>
                <div class="col-12">
                    <div class="form-floating mb-4 pr-5">
